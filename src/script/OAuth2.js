...
// jshint evil:true
  ...
  Service_.prototype.setServiceName = function(serviceName) {
    this.serviceName_ = serviceName;
    return this;
  };

  Service_.prototype.handleCallbackWithToken = function(callbackRequest) {
    ...
    return this.fetchToken_(payload);
  };
   ...
   * @private
   */
  Service_.prototype.saveToken = function(token) {
